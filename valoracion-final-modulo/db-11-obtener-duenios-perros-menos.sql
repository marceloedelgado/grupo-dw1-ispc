...
insert into Perro (ID_perro, DNI_duenio, Nombre_perro, Fecha_nac, Sexo) values (1, "11195366", "Barto","2017-03-17","Macho");
...
insert into Perro (ID_perro, DNI_duenio, Nombre_perro, Fecha_nac, Sexo) values (8, "11195366", "Simon","2017-01-17","Macho");

insert into Historial(ID_Historial,Perro_nro,Fecha, Descripcion, Monto) values (1,1,"2022-02-18", "Vacunas",5000);
insert into Historial(ID_Historial,Perro_nro,Fecha, Descripcion, Monto) values (2,2,"2021-08-20", "Pipeta y Control",5000);
insert into Historial(ID_Historial,Perro_nro,Fecha, Descripcion, Monto) values (3,3,"2021-01-10", "Pipeta y Control",5000);
insert into Historial(ID_Historial,Perro_nro,Fecha, Descripcion, Monto) values (4,4,"2020-03-13", "Castracion",10000);
...
WHERE p.Fecha_nac > '2017-01-01' and p.Fecha_nac < '2022-01-01'
and h.Fecha > '2022-01-01' and h.Fecha < '2022-12-31' ;